<h1 align="center">FunPay Support</h1>
<h4 align="center">Простой и эффективный бот для автоматизации FunPay</h4>

<h2 align="center">Перед началом настоятельно рекомендую залететь в наш <a href="https://t.me/funpay_supp">Telegram
...
- [Возможности](#robot-возможности)
    ...
    - [Мультиаккаунт](#busts_in_silhouette-мультиаккаунт)
...
### :busts_in_silhouette: **Мультиаккаунт**

Система мультиаккаунтов позволяет управлять несколькими аккаунтами FunPay из одного Telegram-бота.

- Добавление неограниченного количества аккаунтов FunPay.
- Каждый аккаунт работает как отдельный подпроцесс с собственным конфигом и набором плагинов.
- У каждого аккаунта свой Telegram-бот для независимого управления.
- Обязательное использование прокси для каждого аккаунта с автоматической проверкой работоспособности.
- Запуск / остановка / удаление аккаунтов прямо из Telegram.
- Просмотр статуса аккаунтов (баланс, количество лотов, активные заказы) в реальном времени.
- Удобный список аккаунтов с индикацией статуса: 🟢 работает, 🔴 остановлен, ⚠️ ошибка прокси.
...
- [Канал с плагинами](https://t.me/EstateMarket_robot)
- [Канал с новостями](https://t.me/estatemarket_news)

## :arrow_down: Установка

Арендовать виртуальный сервер можно на [OneDash](https://t.me/RDPOneDashBot?start=116762). Выбирайте Ubuntu 22-24 версии,
...
2. Скачайте [FunPay Support](https://github.com/EstateGroup/FPSupport/archive/refs/heads/main.zip)
3. Перенесите архив `FPSupport-main.zip` в нужное Вам место и распакуйте его.
4. Перейдите в папку `FPSupport-main`.
...
1. Выполните команду:
   `wget https://raw.githubusercontent.com/EstateGroup/FPSupport/main/install-fpc.sh -O install-fpc.sh && bash install-fpc.sh`
...
нашем [Telegram чате](https://t.me/funpay_supp).

## :star: Star it

Если вам удобно пользоваться FunPay Support, не забудьте поставить :star: звезду :star: данному проекту в правом
