...
logger = getLogger("FunPayAutobot.announcements")
localizer = Localizer()
...
def get_announcement(ignore_last_tag: bool = False) -> dict | None:
    ...
    try:
        response = requests.get("https://api.github.com/gists/03e084d52cffb474815d86985c8accfe", headers=headers)
...
def announcements_loop_iteration(crd: FPSupport, ignore_last_tag: bool = False):
    global LAST_TAG
...
def announcements_loop(crd: FPSupport):
    """
