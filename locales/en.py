...
mm_proxy = "🌐 Proxy"
mm_multi_account = "👥 Multi-accounts"
...
access_granted = "🔓 Access granted!\n\n" \
                 ...
                 "⚙️ To open the <i>FPSupport</i> settings menu, send me /menu."
...
✅ <i>FPSupport</i> gets the full chat history and sees all data about all new messages.
✅ <i>FPSupport</i> can see images in chat and forward them to <i>Telegram</i> chat.
✅ <i>FPSupport</i> can determine exactly who wrote, whether it was you, your interlocutor, or a 3rd party (arbitrator).
❌ Because <i>FPSupport</i> gets the full chat history to detect new messages, the chat becomes "read" (not lit orange).
...
❌ <i>FPSupport</i> doesn't get the full chat history, so it sees only the last message. If the user quickly writes several messages, <i>FPSupport</i> will see only the last one.
❌ <i>FPSupport</i> cannot see images in chat and forward them to <i>Telegram</i> chat.
❌ <i>FPSupport</i> cannot determine exactly who wrote: you or the person you are chatting with. If the chat is not read, then the message is from the interlocutor, otherwise it is from you. However, if you are viewing the chat when you receive messages, this logic can sometimes fail. Also, <i>FPSupport</i> will not be able to determine if a 3rd party (arbitrator) wrote into the chat.

❗ If you click the <code>More</code> button in a new message notification, <i>FPSupport</i> will "read" the chat and show the last 15 messages, including images. <i>FPSupport</i> will also be able to determine who the author of the messages is."""
...
❌ <i>FPSupport</i> is not initialized yet and none of its functions work.\n
🔃 As soon as <i>FPSupport</i> is initialized, this message will change.\n
📋 If <i>FPSupport</i> does not initialize for a long time, check the logs with /logs

🛠️ github.com/EstateGroup/FPSupport
👨‍💻 @EstateGroup0
🧩 @EstateMarket_robot
💬 @funpay_supp
📰 @estatemarket_news
...
FunPayAutobot_init = """✅ <b><u>FPSupport initialized!</u></b>\n
...
<b>CPU:</b>
{}
    Used by <i>FPSupport</i>: <code>{}%</code>

<b>RAM:</b>
    Total:  <code>{} MB</code>
    Used:  <code>{} MB</code>
    Free:  <code>{} MB</code>
    Used by <i>FPSupport</i>:  <code>{} MB</code>
...
update_lasted = "✅ You have the latest version FPSupport"
...
update_done = "✅ The update is installed! Restart the FPSupport with the /restart command."
update_done_exe = "✅ The update is installed! New <code>FPSupport.exe</code> is in <code>update</code> folder. " \
                  "Turn off <i>FPSupport</i>, replace old <code>FPSupport.exe</code> with new one and run <code>Start.bat</code>. "
...
pl_new = "Send me a plugin.\n\n<b>⚠️ ATTENTION! Downloading plugins from questionable sources may lead to unfortunate consequences.\n" \
         "@EstateMarket_robot solves most potential issues.</b>"

au_user_settings = "Settings for user {}"
adv_FunPayAutobot = "😎 FPSupport - the best bot for FunPay"
adv_description = """🤖 FPSupport 🤖
...
desc_lang = desc_main
desc_gs = "Here you can turn the basic <i>FPSupport</i> functions on and off."
...
cmd_restart = "restart FPSupport"
cmd_power_off = "shutdown FPSupport"
...
# Multi-accounts
ma_title = "👥 <b>Multi-accounts</b>"
ma_desc = "Here you can manage additional FunPay accounts."
ma_no_accounts = "No accounts added."
ma_account_info = """👤 <b>{}</b>
🔑 Golden Key: <code>{}...{}</code>
🌐 Proxy: <code>{}</code>
📊 Status: {}"""

ma_account_info_full = """👤 <b>{}</b>
🔑 Golden Key: <code>{}...{}</code>
👑 Account: <code>{}</code> | <code>{}</code>
💰 Balance: <code>{}₽, {}$, {}€</code>
📊 Active orders: <code>{}</code>
📦 Total lots: <code>{}</code>
🌐 Proxy: <code>{}</code>
📊 Status: {}
🕐 Updated: <code>{}</code>"""

ma_status_running = "🟢 Running"
ma_status_stopped = "🔴 Stopped"
ma_status_proxy_error = "⚠️ Proxy error"
ma_status_starting = "🔄 Starting..."
ma_add_account = "➕ Add account"
ma_enter_golden_key = "🔑 Step 1/4: Enter golden_key from FunPay account:"
ma_enter_bot_token = "🤖 Step 2/4: Enter Telegram bot token (get from @BotFather):"
ma_enter_bot_password = "🔐 Step 3/4: Create a password for this bot (min. 8 characters):"
ma_enter_proxy = "🌐 Step 4/4: Enter proxy (REQUIRED, format: login:password@ip:port):"
ma_invalid_golden_key = "❌ Invalid golden_key format. Must be 32 characters."
ma_invalid_bot_token = "❌ Invalid bot token format. Try again."
ma_invalid_password = "❌ Weak password. Min. 8 chars, uppercase + lowercase + digit."
ma_invalid_proxy = "❌ Invalid proxy format. Use: login:password@ip:port"
ma_proxy_required = "⚠️ Proxy is required for multi-accounts."
ma_account_added = "✅ Multi-account created!\n🔑 golden_key: <code>{}</code>\n🤖 Bot: @{}\n\nNow send /start to this bot to begin."
ma_account_started = "✅ Account <b>{}</b> started."
ma_account_stopped = "✅ Account <b>{}</b> stopped."
ma_account_deleted = "✅ Account <b>{}</b> deleted."
ma_account_not_found = "❌ Account not found."
ma_proxy_updated = "✅ Proxy for account <b>{}</b> updated."
ma_proxy_check_fail = "❌ Proxy check failed: {}"
ma_confirm_delete = "Are you sure you want to delete account <b>{}</b>?"
ma_back = "🔙 Back to accounts"
ma_start = "▶️ Start"
ma_stop = "⏹ Stop"
ma_edit_proxy = "🌐 Edit proxy"
ma_delete = "🗑 Delete"
ma_confirm_yes = "✅ Yes, delete"
ma_confirm_no = "❌ Cancel"
